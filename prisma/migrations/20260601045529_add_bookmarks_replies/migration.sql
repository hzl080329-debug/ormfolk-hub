...
INSERT INTO "new_Comment" ("content", "createdAt", "creationId", "id", "likeCount", "postId", "userId") SELECT "content", "createdAt", "creationId", "id", "likeCount", "postId", "userId" FROM "Comment";
DROP TABLE "Comment";
